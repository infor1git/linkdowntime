...
echo "<th>" . __('Total Incidents', 'linkdowntime') . "</th>";
echo "<th>" . __('Affected Locations', 'linkdowntime') . "</th>";
echo "<th>" . __('Total Downtime (hours)', 'linkdowntime') . "</th>";
echo "<th>" . __('Downtime %', 'linkdowntime') . "</th>";
echo "<th>" . __('Uptime %', 'linkdowntime') . "</th>";
echo "</tr>";
...
echo "<th>" . __('Incidents', 'linkdowntime') . "</th>";
echo "<th>" . __('Downtime (hours)', 'linkdowntime') . "</th>";
echo "<th>" . __('Downtime %', 'linkdowntime') . "</th>";
echo "<th>" . __('Uptime %', 'linkdowntime') . "</th>";
echo "</tr>";
